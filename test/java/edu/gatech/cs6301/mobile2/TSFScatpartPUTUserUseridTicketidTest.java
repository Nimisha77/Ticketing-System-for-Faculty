...
/**
 * This test class tests the end point: PUT /user/<userid>/tickets/<ticketid>
 */
public class TSFScatpartPUTUserUseridTicketidTest {
    ...
    public void tsfsTest1() throws IOException {
        //Testing what would happen if there is an Empty user id
        HttpGet httpRequest = new HttpGet(baseUrl + "/user/" + "" + "/tickets/1234");
    ...
    public void tsfsTest2() throws IOException {
        HttpGet httpRequest = new HttpGet(baseUrl + "/user/" + "$$$kpierre$$$" + "/tickets/1234");
        httpRequest.addHeader("accept", "application/json");
    ...
    /**
     * Purpose: Tests whether the server returns the correct error code when the user id contains a space
     * @throws IOException thrown when error happens after executing a http request
     */
    @Test
    ...
    public void tsfsTest5() throws IOException {
        HttpGet httpRequest = new HttpGet(baseUrl + "/user/" + "kpierre" + "/tickets/kpierre");
        httpRequest.addHeader("accept", "application/json");
    ...
    public void tsfsTest6() throws IOException {
        ...
        //We are pretending that ticket with ticket id 54321 doesn't belong to the user kpierre
        HttpGet httpRequest = new HttpGet(baseUrl + "/user/" + "kpierre" + "/tickets/54321");
        httpRequest.addHeader("accept", "application/json");
    ...
    public void tsfsTest7() throws IOException {
        ...
        StringEntity input = new StringEntity("{\"id\":10000,\"title\":\"string\",\"description\":\"string\",\"status\"" +
                ...
                "string\",\"watchers\":[\"string\"],\"createdDate\":\"2023-03-01T19:02:52.360Z\",\"modifiedDate\"" +
                ":\"2023-03-01T19:02:52.360Z\"}");
        ...
        HttpGet httpRequest2 = new HttpGet(baseUrl + "/user/" + "kpierre" + "/tickets/10000");
        httpRequest.addHeader("accept", "application/json");
    ...
    /**
     * Purpose: Tests whether the server returns the correct error code when the ticket id is empty
     * @throws IOException thrown when error happens after executing a http request
     */
    @Test
    public void tsfsTest8() throws IOException {
        HttpGet httpRequest = new HttpGet(baseUrl + "/user/" + "kpierre" + "/tickets//");
        httpRequest.addHeader("accept", "application/json");
