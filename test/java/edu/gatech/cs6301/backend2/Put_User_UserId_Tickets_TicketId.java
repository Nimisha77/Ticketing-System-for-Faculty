...
public class Put_User_UserId_Tickets_TicketId {
    ...
    public void tsfsTest1() throws Exception {
        try {
            CloseableHttpResponse response = updateTicket(
                    httpclient,
                    baseUrl,
                    "",
                    EXISTING_TICKET_ID,
    ...
    // Purpose: Tests if a 404 error code is returned when the ticketId is a non-integer string
    @Test
    ...
    // Purpose: Tests if a 404 error code is returned when the ticketId doesn't exist
    @Test
    ...
    // Purpose: Tests if a 200 code with updated entity is returned when all is valid and there are no watchers
    @Test
    ...
    // Purpose: Tests if a 200 code with updated entity is returned when all is valid and there is one watcher
    @Test
    ...
    // Purpose: Tests if a 200 code with updated entity is returned when all is valid and there are multiple watchers
    @Test
