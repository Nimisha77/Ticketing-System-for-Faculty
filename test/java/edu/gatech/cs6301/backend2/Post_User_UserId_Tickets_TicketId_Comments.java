...
public class Post_User_UserId_Tickets_TicketId_Comments {
    ...
    // Purpose: Tests if a 400 error code is returned when the comment description is empty
    @Test
    ...
    // Purpose: Tests if a 200 error code and the ticket is returned when the userId and ticketId exists, and ticketId
